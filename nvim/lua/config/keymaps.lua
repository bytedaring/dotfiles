...
-- rust crates.nvim
vim.keymap.set("n", "<leader>ct", [[:lua require("crates").toggle()]], opts)
vim.keymap.set("n", "<leader>cr", [[:lua require("crates").reload()]], opts)

vim.keymap.set("n", "<leader>cv", [[:lua require("crates").show_versions_popup()]], opts)
vim.keymap.set("n", "<leader>cf", [[:lua require("crates").show_features_popup()]], opts)
vim.keymap.set("n", "<leader>cd", [[:lua require("crates").show_dependencies_popup()]], opts)

vim.keymap.set("n", "<leader>cu", [[:lua require("crates").update_crate()]], opts)
vim.keymap.set("v", "<leader>cu", [[:lua require("crates").update_crates()]], opts)
vim.keymap.set("n", "<leader>ca", [[:lua require("crates").update_all_crates()]], opts)
vim.keymap.set("n", "<leader>cU", [[:lua require("crates").upgrade_crate()]], opts)
vim.keymap.set("v", "<leader>cU", [[:lua require("crates").upgrade_crates()]], opts)
vim.keymap.set("n", "<leader>cA", [[:lua require("crates").upgrade_all_crates()]], opts)

vim.keymap.set("n", "<leader>cx", [[:lua require("crates").expand_plain_crate_to_inline_table()]], opts)
vim.keymap.set("n", "<leader>cX", [[:lua require("crates").extract_crate_into_table()]], opts)

vim.keymap.set("n", "<leader>cH", [[:lua require("crates").open_homepage()]], opts)
vim.keymap.set("n", "<leader>cR", [[:lua require("crates").open_repository()]], opts)
vim.keymap.set("n", "<leader>cD", [[:lua require("crates").open_documentation()]], opts)
vim.keymap.set("n", "<leader>cC", [[:lua require("crates").open_crates_io()]], opts)
