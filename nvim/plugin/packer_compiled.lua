...
_G.packer_plugins = {
  ...
  ["nvim-tree.lua"] = {
    ...
    config = { "\27LJ\2\n¿\4\0\0\6\0\19\0\0276\0\0\0009\0\1\0)\1\1\0=\1\2\0)\1\1\0=\1\3\0006\1\4\0'\3\5\0B\1\2\0029\1\6\0015\3\a\0005\4\b\0004\5\0\0=\5\t\4=\4\n\0035\4\v\0=\4\f\0035\4\r\0=\4\14\0035\4\15\0=\4\16\3B\1\2\0016\1\0\0009\1\17\1'\3\18\0B\1\2\1K\0\1\0µ\1        augroup nvim-tree\n          autocmd!\n          autocmd BufEnter * if winnr('$') == 1 && bufname() == 'NvimTree_' . tabpagenr() | quit | endif\n        augroup END\n      \bcmd\ffilters\1\0\1\rdotfiles\2\tview\1\0\1\nwidth\3(\bgit\1\0\1\ftimeout\3¬\2\24update_focused_file\16ignore_list\1\0\2\venable\2\15update_cwd\1\1\0\6\18open_on_setup\2\16open_on_tab\1\18hijack_cursor\1\15update_cwd\2\18disable_netrw\2\17hijack_netrw\2\nsetup\14nvim-tree\frequire\29nvim_tree_indent_markers\30nvim_tree_respect_buf_cwd\6g\bvim\0" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'vim-ultest', 'vim-test', 'Comment.nvim', 'trouble.nvim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-virtual-text', 'vim-ultest', 'vim-test', 'Comment.nvim', 'trouble.nvim', 'guihua.lua', 'go.nvim', 'nvim-dap'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-repeat', 'indent-blankline.nvim', 'nvim-autopairs', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
