...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'nvim-dap-ui', 'nvim-dap-virtual-text', 'go.nvim', 'trouble.nvim', 'guihua.lua', 'vim-test', 'vim-ultest', 'Comment.nvim'}, { ft = "go" }, _G.packer_plugins)]]
