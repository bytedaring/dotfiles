...
_G.packer_plugins = {
  ...
  ["nvim-tree.lua"] = {
    ...
    config = { "\27LJ\2\nž\4\0\0\6\0\18\0\0256\0\0\0009\0\1\0)\1\1\0=\1\2\0006\1\3\0'\3\4\0B\1\2\0029\1\5\0015\3\6\0005\4\a\0004\5\0\0=\5\b\4=\4\t\0035\4\n\0=\4\v\0035\4\f\0=\4\r\0035\4\14\0=\4\15\3B\1\2\0016\1\0\0009\1\16\1'\3\17\0B\1\2\1K\0\1\0µ\1        augroup nvim-tree\n          autocmd!\n          autocmd BufEnter * if winnr('$') == 1 && bufname() == 'NvimTree_' . tabpagenr() | quit | endif\n        augroup END\n      \bcmd\ffilters\1\0\1\rdotfiles\2\tview\1\0\1\nwidth\3(\bgit\1\0\1\ftimeout\3¬\2\24update_focused_file\16ignore_list\1\0\2\15update_cwd\1\venable\2\1\0\6\18disable_netrw\2\15update_cwd\2\18hijack_cursor\1\16open_on_tab\1\18open_on_setup\2\17hijack_netrw\2\nsetup\14nvim-tree\frequire\30nvim_tree_respect_buf_cwd\6g\bvim\0" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-colorizer.lua', 'trouble.nvim', 'Comment.nvim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-ultest', 'vim-test', 'vimspector', 'trouble.nvim', 'Comment.nvim'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-virtual-text', 'vim-ultest', 'vim-test', 'trouble.nvim', 'nvim-dap', 'guihua.lua', 'go.nvim', 'Comment.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-repeat', 'nvim-treesitter', 'nvim-autopairs', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
