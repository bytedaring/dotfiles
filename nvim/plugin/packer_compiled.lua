...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-ultest', 'vimspector', 'trouble.nvim', 'vim-test', 'Comment.nvim'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'guihua.lua', 'nvim-dap-virtual-text', 'vim-ultest', 'nvim-dap', 'go.nvim', 'trouble.nvim', 'vim-test', 'Comment.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'vimspector', 'trouble.nvim', 'Comment.nvim', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'indent-blankline.nvim', 'vim-surround', 'nvim-treesitter', 'nvim-autopairs', 'git-blame.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
