...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    config = { "\27LJ\2\nå\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\nicons\1\0\2\15breakpoint\tüî¥\15currentpos\tüëâ\1\0\3\20run_in_floaterm\1\flsp_cfg\1\ago\vgo1.18\nsetup\ago\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'guihua.lua', 'go.nvim', 'vim-ultest', 'nvim-dap-virtual-text', 'Comment.nvim', 'trouble.nvim', 'vim-test'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-ultest', 'Comment.nvim', 'vimspector', 'trouble.nvim', 'vim-test'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'Comment.nvim', 'Comment.nvim', 'vimspector', 'trouble.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
