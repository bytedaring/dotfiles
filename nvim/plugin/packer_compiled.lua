...
vim.cmd [[au FileType go ++once lua require("packer.load")({'guihua.lua', 'trouble.nvim', 'nvim-dap', 'vim-test', 'vim-ultest', 'Comment.nvim', 'nvim-dap-virtual-text', 'go.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nlua.nvim', 'trouble.nvim', 'vimspector', 'Comment.nvim', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'nvim-autopairs', 'git-blame.nvim', 'vim-repeat', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
