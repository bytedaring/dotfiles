...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    config = { "\27LJ\2\nå\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\nicons\1\0\2\15currentpos\tüëâ\15breakpoint\tüî¥\1\0\3\20run_in_floaterm\1\flsp_cfg\1\ago\vgo1.18\nsetup\ago\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'neotest-go', 'neotest', 'FixCursorHold.nvim', 'guihua.lua', 'Comment.nvim', 'go.nvim', 'vim-test', 'nvim-dap-virtual-text', 'nvim-dap', 'trouble.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-surround', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'lsp_signature.nvim', 'friendly-snippets', 'diffview.nvim', 'vim-repeat', 'vimspector', 'vim-illuminate', 'trouble.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
