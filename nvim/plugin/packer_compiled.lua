...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-ultest', 'Comment.nvim', 'vim-test', 'trouble.nvim', 'guihua.lua', 'go.nvim', 'nvim-dap', 'nvim-dap-virtual-text'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'vimspector', 'Comment.nvim', 'Comment.nvim', 'trouble.nvim', 'nlua.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'vimspector', 'trouble.nvim'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'vim-ultest', 'Comment.nvim', 'vim-test', 'trouble.nvim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'vim-repeat', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
