...
try_loadstring("\27LJ\2\n£\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\roverride\1\0\1\fdefault\2\tfish\1\0\0\1\0\4\ticon\bîž•\ncolor\f#51a0cf\16cterm_color\a66\tname\tFish\nsetup\22nvim-web-devicons\frequire\0", "config", "nvim-web-devicons")
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'vim-test', 'trouble.nvim', 'Comment.nvim', 'vim-ultest'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType vim ++once lua require("packer.load")({'trouble.nvim', 'Comment.nvim'}, { ft = "vim" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'vimspector', 'trouble.nvim', 'nlua.nvim', 'Comment.nvim', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'go.nvim', 'guihua.lua', 'nvim-dap-virtual-text', 'vim-test', 'trouble.nvim', 'nvim-dap-ui', 'nvim-dap', 'Comment.nvim', 'vim-ultest'}, { ft = "go" }, _G.packer_plugins)]]
