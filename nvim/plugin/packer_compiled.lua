...
vim.cmd [[au FileType go ++once lua require("packer.load")({'go.nvim', 'trouble.nvim', 'guihua.lua', 'Comment.nvim', 'vim-test', 'nvim-dap', 'vim-ultest', 'nvim-dap-virtual-text'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'trouble.nvim', 'Comment.nvim', 'vim-test', 'vim-ultest'}, { ft = "python" }, _G.packer_plugins)]]
