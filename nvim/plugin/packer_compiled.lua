...
vim.cmd [[au FileType python ++once lua require("packer.load")({'trouble.nvim', 'vim-test', 'Comment.nvim', 'vim-ultest', 'vimspector'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'trouble.nvim', 'nvim-dap', 'vim-test', 'Comment.nvim', 'vim-ultest', 'nvim-dap-virtual-text', 'go.nvim', 'guihua.lua'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'vim-surround', 'nvim-autopairs', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
