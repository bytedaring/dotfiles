...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'nvim-dap-ui', 'nvim-dap-virtual-text', 'vim-test', 'Comment.nvim', 'vim-ultest', 'go.nvim', 'trouble.nvim', 'guihua.lua'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'vim-test', 'Comment.nvim', 'vim-ultest', 'trouble.nvim'}, { ft = "python" }, _G.packer_plugins)]]
