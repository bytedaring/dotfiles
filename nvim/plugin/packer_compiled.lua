...
_G.packer_plugins = {
  ...
  ["nvim-tree.lua"] = {
    ...
    config = { "\27LJ\2\nÉ\5\0\0\a\0\24\0\0316\0\0\0009\0\1\0)\1\1\0=\1\2\0006\1\3\0'\3\4\0B\1\2\0029\1\5\0015\3\6\0005\4\n\0005\5\a\0005\6\b\0=\6\t\5=\5\v\4=\4\f\0035\4\r\0004\5\0\0=\5\14\4=\4\15\0035\4\16\0=\4\17\0035\4\18\0=\4\19\0035\4\20\0=\4\21\3B\1\2\0016\1\0\0009\1\22\1'\3\23\0B\1\2\1K\0\1\0µ\1        augroup nvim-tree\n          autocmd!\n          autocmd BufEnter * if winnr('$') == 1 && bufname() == 'NvimTree_' . tabpagenr() | quit | endif\n        augroup END\n      \bcmd\ffilters\1\0\1\rdotfiles\2\tview\1\0\1\nwidth\3(\bgit\1\0\1\ftimeout\3¨\2\24update_focused_file\16ignore_list\1\0\2\venable\2\15update_cwd\1\rrenderer\19indent_markers\1\0\0\nicons\1\0\3\vcorner\t‚îî \tedge\t‚îÇ \tnone\a  \1\0\1\venable\2\1\0\6\18hijack_cursor\1\17hijack_netrw\2\18open_on_setup\2\15update_cwd\2\18disable_netrw\2\16open_on_tab\1\nsetup\14nvim-tree\frequire\30nvim_tree_respect_buf_cwd\6g\bvim\0" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope.nvim"] = {
    ...
    commands = { "Telescope" },
    config = { "\27LJ\2\nØ\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\15extensions\1\0\0\bfzf\1\0\0\1\0\4\nfuzzy\2\28override_generic_sorter\2\25override_file_sorter\2\14case_mode\16ignore_case\nsetup\14telescope\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-test', 'Comment.nvim', 'trouble.nvim', 'vimspector', 'vim-ultest'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'nvim-colorizer.lua'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'Comment.nvim', 'Comment.nvim', 'trouble.nvim', 'nlua.nvim', 'vimspector'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType vim ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim'}, { ft = "vim" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-test', 'Comment.nvim', 'trouble.nvim', 'guihua.lua', 'go.nvim', 'nvim-dap', 'nvim-dap-virtual-text', 'vim-ultest'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'indent-blankline.nvim', 'nvim-treesitter', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
