...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    config = { "\27LJ\2\nå\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\nicons\1\0\2\15breakpoint\tüî¥\15currentpos\tüëâ\1\0\3\flsp_cfg\1\20run_in_floaterm\1\ago\vgo1.18\nsetup\ago\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-colorizer.lua', 'Comment.nvim', 'nvim-ts-autotag', 'trouble.nvim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'vimspector', 'Comment.nvim', 'Comment.nvim', 'trouble.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'neotest', 'FixCursorHold.nvim', 'go.nvim', 'vim-test', 'Comment.nvim', 'nvim-dap-virtual-text', 'trouble.nvim', 'nvim-dap', 'neotest-go', 'guihua.lua'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'vim-test', 'Comment.nvim', 'trouble.nvim'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'diffview.nvim', 'friendly-snippets', 'vimspector', 'lsp_signature.nvim', 'vim-illuminate', 'vim-repeat', 'trouble.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-surround', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
