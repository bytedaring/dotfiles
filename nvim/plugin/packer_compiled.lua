...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'trouble.nvim', 'Comment.nvim', 'Comment.nvim', 'nlua.nvim', 'vimspector'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'vim-ultest', 'vim-test', 'nvim-dap-virtual-text', 'trouble.nvim', 'Comment.nvim', 'go.nvim', 'guihua.lua'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-treesitter', 'vim-surround', 'vim-repeat', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
