...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'nvim-dap-ui', 'nvim-dap-virtual-text', 'trouble.nvim', 'go.nvim', 'guihua.lua', 'vim-ultest', 'Comment.nvim', 'vim-test'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'trouble.nvim', 'vimspector', 'Comment.nvim', 'Comment.nvim', 'nlua.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'trouble.nvim', 'vim-ultest', 'vimspector', 'Comment.nvim', 'vim-test'}, { ft = "python" }, _G.packer_plugins)]]
