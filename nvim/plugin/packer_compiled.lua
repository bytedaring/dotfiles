...
_G.packer_plugins = {
  ...
  ["project.nvim"] = {
    ...
    loaded = true,
    path = "/Users/xiaoxiwang/.local/share/nvim/site/pack/packer/start/project.nvim",
