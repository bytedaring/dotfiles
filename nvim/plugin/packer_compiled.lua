...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-test', 'vim-ultest', 'nvim-dap-virtual-text', 'Comment.nvim', 'go.nvim', 'guihua.lua', 'trouble.nvim', 'nvim-dap'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'vim-surround', 'nvim-treesitter', 'indent-blankline.nvim', 'nvim-autopairs'}, { event = "BufRead *" }, _G.packer_plugins)]]
