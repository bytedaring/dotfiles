...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    config = { "\27LJ\2\n£\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\roverride\1\0\1\fdefault\2\tfish\1\0\0\1\0\4\16cterm_color\a66\tname\tFish\ncolor\f#51a0cf\ticon\bîž•\nsetup\22nvim-web-devicons\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'trouble.nvim', 'go.nvim', 'guihua.lua', 'vim-test', 'vim-ultest', 'nvim-dap', 'nvim-dap-ui', 'Comment.nvim', 'nvim-dap-virtual-text'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'trouble.nvim', 'Comment.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'trouble.nvim', 'vimspector', 'nlua.nvim', 'cmp_luasnip', 'Comment.nvim', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
