...
vim.cmd [[au FileType go ++once lua require("packer.load")({'go.nvim', 'guihua.lua', 'trouble.nvim', 'vim-test', 'nvim-dap-virtual-text', 'Comment.nvim', 'vim-ultest', 'nvim-dap'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType vim ++once lua require("packer.load")({'trouble.nvim', 'Comment.nvim'}, { ft = "vim" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'trouble.nvim', 'vim-test', 'vimspector', 'Comment.nvim', 'vim-ultest'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-autopairs', 'vim-surround', 'vim-repeat', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
