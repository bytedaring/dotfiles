...
vim.cmd [[au FileType go ++once lua require("packer.load")({'trouble.nvim', 'go.nvim', 'guihua.lua', 'vim-ultest', 'nvim-dap', 'Comment.nvim', 'vim-test', 'nvim-dap-ui', 'nvim-dap-virtual-text'}, { ft = "go" }, _G.packer_plugins)]]
