...
vim.cmd [[au FileType python ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'vim-test', 'vimspector'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-colorizer.lua', 'Comment.nvim', 'trouble.nvim', 'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'Comment.nvim', 'trouble.nvim', 'vim-test', 'nvim-dap-virtual-text', 'guihua.lua', 'neotest', 'neotest-go', 'go.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'indent-blankline.nvim', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
