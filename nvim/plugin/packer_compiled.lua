...
vim.cmd [[au FileType go ++once lua require("packer.load")({'Comment.nvim', 'guihua.lua', 'vim-test', 'go.nvim', 'nvim-dap-virtual-text', 'neotest', 'neotest-go', 'trouble.nvim', 'nvim-dap'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'vim-surround', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
