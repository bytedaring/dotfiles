...
_G.packer_plugins = {
  ...
  ["indent-blankline.nvim"] = {
    config = { "\27LJ\2\né\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\31show_current_context_start\1\25space_char_blankline\6 \25show_current_context\2\nsetup\21indent_blankline\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType sh ++once lua require("packer.load")({'trouble.nvim', 'Comment.nvim'}, { ft = "sh" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'trouble.nvim', 'vimspector', 'Comment.nvim', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'trouble.nvim', 'nvim-ts-autotag', 'nvim-colorizer.lua', 'Comment.nvim'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'trouble.nvim', 'vimspector'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'trouble.nvim', 'vimspector', 'Comment.nvim', 'vim-test'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'trouble.nvim', 'nvim-ts-autotag', 'Comment.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'neotest', 'FixCursorHold.nvim', 'nvim-dap', 'trouble.nvim', 'go.nvim', 'neotest-go', 'nvim-dap-virtual-text', 'Comment.nvim', 'vim-test', 'guihua.lua'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-treesitter', 'vim-surround'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-illuminate', 'trouble.nvim', 'friendly-snippets', 'lsp_signature.nvim', 'diffview.nvim', 'vimspector'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
