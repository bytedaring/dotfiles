...
_G.packer_plugins = {
  ...
  ["monokai.nvim"] = {
    ...
    loaded = true,
    path = "/Users/xiaoxiwang/.local/share/nvim/site/pack/packer/start/monokai.nvim",
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-test', 'vim-ultest', 'nvim-dap-ui', 'nvim-dap-virtual-text', 'go.nvim', 'guihua.lua', 'nvim-dap', 'Comment.nvim', 'trouble.nvim'}, { ft = "go" }, _G.packer_plugins)]]
