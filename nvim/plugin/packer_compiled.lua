...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    config = { "\27LJ\2\nh\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\nicons\1\0\0\1\0\2\15currentpos\tðŸ‘‰\15breakpoint\tðŸ”´\nsetup\ago\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'Comment.nvim', 'vimspector'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'nvim-dap-ui', 'Comment.nvim', 'go.nvim', 'guihua.lua'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'Comment.nvim', 'Comment.nvim', 'vimspector'}, { ft = "lua" }, _G.packer_plugins)]]
