...
vim.cmd [[au FileType python ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'vimspector', 'vim-test', 'vim-ultest'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'guihua.lua', 'Comment.nvim', 'trouble.nvim', 'nvim-dap', 'vim-test', 'go.nvim', 'nvim-dap-virtual-text', 'vim-ultest'}, { ft = "go" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-autopairs', 'vim-surround', 'nvim-treesitter', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
