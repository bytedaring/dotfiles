...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-virtual-text', 'vim-ultest', 'vim-test', 'nvim-dap', 'trouble.nvim', 'Comment.nvim', 'guihua.lua', 'go.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-ts-autotag', 'trouble.nvim', 'Comment.nvim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'vim-ultest', 'vim-test', 'trouble.nvim', 'Comment.nvim'}, { ft = "python" }, _G.packer_plugins)]]
