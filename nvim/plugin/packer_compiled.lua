...
vim.cmd [[au FileType go ++once lua require("packer.load")({'guihua.lua', 'nvim-dap', 'nvim-dap-ui', 'nvim-dap-virtual-text', 'Comment.nvim', 'go.nvim', 'vim-ultest', 'vim-test', 'trouble.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vimspector', 'Comment.nvim', 'vim-ultest', 'vim-test', 'trouble.nvim'}, { ft = "python" }, _G.packer_plugins)]]
