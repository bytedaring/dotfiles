...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'Comment.nvim', 'Comment.nvim', 'nlua.nvim', 'vimspector', 'trouble.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType sh ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'null-ls.nvim'}, { ft = "sh" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-virtual-text', 'Comment.nvim', 'vim-ultest', 'nvim-dap', 'vim-test', 'trouble.nvim', 'guihua.lua', 'go.nvim'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'vimspector', 'trouble.nvim'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'Comment.nvim', 'vimspector', 'vim-ultest', 'vim-test', 'trouble.nvim'}, { ft = "python" }, _G.packer_plugins)]]
