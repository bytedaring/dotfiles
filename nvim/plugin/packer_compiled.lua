...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    config = { "\27LJ\2\nå\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\nicons\1\0\2\15currentpos\tüëâ\15breakpoint\tüî¥\1\0\3\flsp_cfg\1\20run_in_floaterm\1\ago\vgo1.18\nsetup\ago\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-ultest', 'vim-test', 'trouble.nvim', 'Comment.nvim', 'vimspector'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-virtual-text', 'vim-ultest', 'vim-test', 'guihua.lua', 'go.nvim', 'trouble.nvim', 'nvim-dap', 'Comment.nvim'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'trouble.nvim', 'Comment.nvim', 'nvim-colorizer.lua'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-surround', 'vim-repeat', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
