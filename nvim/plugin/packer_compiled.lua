...
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap', 'nvim-dap-ui', 'trouble.nvim', 'nvim-dap-virtual-text', 'vim-ultest', 'go.nvim', 'Comment.nvim', 'guihua.lua', 'vim-test'}, { ft = "go" }, _G.packer_plugins)]]
