...
vim.cmd [[au FileType html ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'nvim-colorizer.lua', 'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType less ++once lua require("packer.load")({'Comment.nvim', 'nvim-colorizer.lua'}, { ft = "less" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-dap-virtual-text', 'Comment.nvim', 'trouble.nvim', 'guihua.lua', 'go.nvim', 'vim-ultest', 'vim-test', 'nvim-dap'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType python ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'vim-ultest', 'vimspector', 'vim-test'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'Comment.nvim', 'trouble.nvim', 'nvim-ts-autotag'}, { ft = "javascript" }, _G.packer_plugins)]]
