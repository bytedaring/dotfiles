...
vim.cmd [[au FileType python ++once lua require("packer.load")({'trouble.nvim', 'vimspector', 'Comment.nvim', 'vim-ultest', 'vim-test'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'trouble.nvim', 'guihua.lua', 'Comment.nvim', 'nvim-dap', 'nvim-dap-virtual-text', 'nvim-dap-ui', 'vim-ultest', 'go.nvim', 'vim-test'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'trouble.nvim', 'vimspector', 'cmp_luasnip', 'nlua.nvim', 'Comment.nvim', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
