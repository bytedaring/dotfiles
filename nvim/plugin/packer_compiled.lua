...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    ...
    commands = { "Telescope" },
    config = { "\27LJ\2\n¯\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\15extensions\1\0\0\bfzf\1\0\0\1\0\4\25override_file_sorter\2\nfuzzy\2\14case_mode\16ignore_case\28override_generic_sorter\2\nsetup\14telescope\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'Comment.nvim', 'vim-ultest', 'nvim-dap-virtual-text', 'go.nvim', 'nvim-dap', 'guihua.lua', 'trouble.nvim', 'vim-test'}, { ft = "go" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'Comment.nvim', 'vim-ultest', 'trouble.nvim', 'vim-test', 'vimspector'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-repeat', 'vim-surround', 'nvim-treesitter', 'nvim-autopairs', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
